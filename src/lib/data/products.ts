...
export const products: Product[] = [
  ...
  // {
  //   id: "p-coffee-cake-mix",
  //   slug: "cinnamon-coffee-cake-mix",
  //   name: "Cinnamon Coffee Cake Mix",
  //   shortDescription: "Swirls of cinnamon sugar and a tender crumb.",
  //   description:
  //     "Weekend mornings, sorted. Layered streusel, warm spice, and a cake that stays moist for days. Your kitchen will smell incredible before it even leaves the oven.",
  //   priceCents: 1599,
  //   category: "mixes",
  //   imageUrl:
  //     "https://images.unsplash.com/photo-1519915218989-05022ef465a7?w=800&q=80",
  //   imageAlt: "Slice of cinnamon coffee cake",
  //   badge: "bestseller",
  // },
  {
